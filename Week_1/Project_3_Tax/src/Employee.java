//This program takes information 
...
//From Class Tax_Demo it recieves an Array.  I believe I executed how an Array works here with the taxes.
public Employee()
{
...
public void setNet_pay(ArrayList<Float> netPay)
{
  ...
  //When the output of employee is called for the following will print out.
		public void writeOutput(int i)
		{
			...
			// one tab, Current then 2 datetwo tabs.
