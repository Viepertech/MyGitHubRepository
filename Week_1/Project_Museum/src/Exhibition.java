...
//Painter Option
   ...
   private String painter(String paintersName, ArrayList<Museum> museumArray) 
   {
       ...
       {
           Scanner currentMuseumFileScan = TextFileIO.createTextRead(museum.getFileName());
           museum.readFile(currentMuseumFileScan);
           for (Painting p: museum.painter(paintersName))
           {
...
//Size Option
   ...
   private String paintingSize(double startSizeUsed, double endSizeUsed, ArrayList<Museum> museumArray)
   {
       ...
       for (Museum x: museumArray)
       {
    	   //SOMETHING HORRIBLE IS HAPPENING IN ALL OF MY TextFileIO Q_Q
           Scanner currentMuseumFileScan = TextFileIO.createTextRead(x.getFileName());
           x.readFile(currentMuseumFileScan);
           //You have left the block of text that kills my code and make me fail this assignment.
